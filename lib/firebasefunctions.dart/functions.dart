...
Future<void> createuser(Map<String, dynamic> userDetails) async {
  try {
    ...
    await firestore.collection("Trainers").add(userDetails);
  } catch (e) {
...
Future<void> updateprofile(Map<String, dynamic> userDetails) async {
  try {
    ...
    await firestore.collection("Trainers").doc(docid).update(userDetails);
  } catch (e) {
...
Future<void> sendmessage(Map<String, dynamic> message) async {
  try {
    await firestore.collection("Trainers").add(message);
  } catch (e) {
...
Future<void> updateprogress(Map<String, dynamic> progress) async {
  try {
    await firestore.collection("Trainers").add(progress);
  } catch (e) {
